...
def open_file(file_name,mode):
    ...
    try:
        ...
        print("Невозможно открыть файл", file_name, ", работа программы будет прекращена.\n", e)
        input("\n\nНажмите Enter, чобы выйти.")
        sys.exit()
    else:
        return the_file
...
def welcome(title):
    """Приветствие игрока"""
    print("\t\tДобро подаловать в игру Викторина!\n")
    print("\t\t", title, "\n")
...
main()
input("Нвдмите Enter, чтобы выйти")